...
public class Transaction {
    ...
    public static class FillRecord {
        ...
        public FillRecord(double price, int volume, String counterpartyType, int orderBookDepth) {
            this(price, volume, counterpartyType, orderBookDepth, Clock.systemUTC());
        }

        FillRecord(double price, int volume, String counterpartyType, int orderBookDepth, Clock clock) {
            this.price = price;
            this.volume = volume;
    ...
    public Transaction(String id, Order buyOrder, Order sellOrder,
        ...
        this(id, buyOrder, sellOrder, price, volume, timestamp, Clock.systemUTC());
    }

    public Transaction(String id, Order buyOrder, Order sellOrder,
            double price, int volume, long timestamp, Clock clock) {
    ...
    public Transaction(String id, String initiatingTraderType, String orderType,
        ...
        this(id, initiatingTraderType, orderType, requestedVolume, estimatedPrice,
                preTradePrice, Clock.systemUTC());
    }

    public Transaction(String id, String initiatingTraderType, String orderType,
            int requestedVolume, double estimatedPrice, double preTradePrice, Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock");
        this.id = id;
     ...
     * 添加填單記錄（市價單用）
     */
    void addFillRecord(double fillPrice, int fillVolume, String counterpartyType, int depth) {
        FillRecord fill = new FillRecord(fillPrice, fillVolume, counterpartyType, depth, clock);
     ...
     * 完成市價單交易記錄
     */
    void completeMarketOrderTransaction(double postTradePrice, int availableDepth, String failureReason) {
        this.executionEndTime = clock.millis();
    ...
    void setMatchingMode(String mode) {
    ...
    void setBuyerInitiated(boolean initiated) {
