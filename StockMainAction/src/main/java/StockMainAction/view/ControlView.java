...
public class ControlView extends JFrame {
    ...
    private void initializeUI() {
        ...
        WindowSizing.apply(this, new Dimension(700, 750),
                new Dimension(620, 650), null);
    ...
    @Override
    public void dispose() {
        if (quickTradePanel != null) quickTradePanel.close();
        if (personalStatsPanel != null) personalStatsPanel.close();
        super.dispose();
    }
    ...
    private JPanel createSystemPanel() {
        ...
        perfCombo.addActionListener(e -> {
            ...
            try {
                performanceModeListener.accept(mode); // [PERF]
            } catch (Throwable t) {
    ...
    public void setPerformanceModeListener(Consumer<String> listener) {
